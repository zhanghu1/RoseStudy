...
public class LoginController {
    ...
    @Post("")
    public String doLogin(final Invocation inv, @Param("loginName") final String loginName,
    ...
    public final static void loginAction(final Invocation inv, final User user) {
        ...
        //final Cookie cookie = new Cookie("JSESSIONID", inv.getRequest().getSession().getId());
